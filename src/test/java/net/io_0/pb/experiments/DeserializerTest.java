...
import static net.io_0.pb.experiments.Deserializer.*;
...
class DeserializerTest {
  ...
  public void deserializeAndValidate_test() {
    ...
    Validation<Pet> validation = deserialize(objectMapper, json, Pet.class).apply(Validators.petValidator.and(customValidators));
