...
import static net.io_0.pb.experiments.validation.PropertyConstraint.on;
import static net.io_0.pb.experiments.validation.PropertyValidators.*;
import static net.io_0.pb.experiments.validation.Validator.of;
