...
If a property type is an `Interface` Maja tries to instantiate it if a default or static method exists that returns the interface type and takes Map<String, Object> as parameter.
